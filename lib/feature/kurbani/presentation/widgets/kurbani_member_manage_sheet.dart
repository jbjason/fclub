...
class KurbaniMemberManageSheet extends StatelessWidget {
  const KurbaniMemberManageSheet({super.key});

  static const _kDeepEmerald = Color(0xFF064E3B);
              ...
              children: [
                ...
                ...provider.members.map((m) {
                  ...
                  return _MemberTile(
                    ...
                    onRemove: canRemove
                        ? () =>
                            context.read<KurbaniProvider>().deleteMember(m.id)
                        : null,
                  );
                }),
...
class _MemberTile extends StatelessWidget {
  ...
  static const _kEmerald = Color(0xFF10B981);
  static const _kRose = Color(0xFFEF4444);

  @override
  Widget build(BuildContext context) {
    final colorScheme = Theme.of(context).colorScheme;
    final gradients = kurbaniAvatarGradients[
        avatarColorIndex % kurbaniAvatarGradients.length];
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border:
                      Border.all(color: _kRose.withValues(alpha: 0.28)),
                ),
                child:
                    Icon(Icons.remove_rounded, size: 16.r, color: _kRose),
              ),
            )
          else
            Container(
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              height: 32.r,
              decoration: BoxDecoration(
                color: _kDeepEmerald.withValues(alpha: 0.12),
                borderRadius: BorderRadius.circular(10.r),
                border: Border.all(
                    color: _kDeepEmerald.withValues(alpha: 0.35)),
              ),
              child: Icon(Icons.add_rounded,
                  size: 16.r, color: _kDeepEmerald),
            ),
          ),
        ],
      ),
