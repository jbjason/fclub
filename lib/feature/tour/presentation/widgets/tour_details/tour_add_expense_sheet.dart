...
import 'package:fclub/feature/tour/presentation/widgets/tour_details/tour_all_beneficiaries_chip.dart';
import 'package:fclub/feature/tour/presentation/widgets/tour_details/tour_category_chip.dart';
import 'package:fclub/feature/tour/presentation/widgets/tour_details/tour_member_select_chip.dart';
...
class _AddExpenseBottomSheetState extends State<AddExpenseBottomSheet> {
  ...
  TourExpenseCategory _category = TourExpenseCategory.food;
  ...
  Future<void> _submit(List<TourParticipant> members) async {
    ...
    try {
      await context.read<TourEventProvider>().addExpense(
        title: title,
        amount: amount,
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ListView(
                  ...
                  children: TourExpenseCategory.values
                      .map(
